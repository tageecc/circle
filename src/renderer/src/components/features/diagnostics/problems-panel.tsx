      ...
      <div className="flex items-center justify-between border-b border-border/30 px-3 py-2">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 text-xs">
            ...
            >
              <span>{t('problems.filter_all', { count: diagnostics.length })}</span>
            </button>
      ...
      <ScrollArea className="flex-1">
        {Object.keys(filteredDiagnostics).length === 0 ? (
          <div className="flex h-full items-center justify-center text-sm text-muted-foreground">
            {filterSeverity === 'all'
              ? t('problems.no_problems')
              : filterSeverity === 'error'
                ? t('problems.no_filter_error')
                : filterSeverity === 'warning'
                  ? t('problems.no_filter_warning')
                  : t('problems.no_filter_info')}
          </div>
        ) : (
          <div className="p-2">
              ...
              <div key={fileName} className="mb-2">
                ...
                >
                  ...
                  <span className="ml-auto text-xs text-muted-foreground">
                    {t('problems.issues_count', { count: items.length })}
                  </span>
                </button>
