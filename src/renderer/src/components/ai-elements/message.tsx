...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      ...
      from === 'user' ? 'is-user ml-auto w-full max-w-[80%] justify-end' : 'is-assistant w-full',
      className
    )}
    {...props}
  />
...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      'chat-message-content flex flex-col gap-2 overflow-hidden text-sm',
      // User 消息：宽度自适应内容，右对齐
      ...
      // Assistant 消息：宽度填满容器
      'group-[.is-assistant]:w-full group-[.is-assistant]:min-w-0 group-[.is-assistant]:text-foreground',
      className
    )}
    {...props}
  >
...
export const MessageResponse = memo(
  ({ className, ...props }: MessageResponseProps) => (
    <Streamdown
      ...
      components={CHAT_MARKDOWN_COMPONENTS as any}
      {...props}
    />
  ),
